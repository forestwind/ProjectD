...
public:
	...
	UFUNCTION(BlueprintCallable, Category = "PD|Stage|Spawn")
	TArray<APDCharacter*> SpawnAllyStageRoundUnits(int32 StageId, int32 RoundIndex, const TArray<int32>& UnitIdList);
...
private:
	...
	static void CollectEnemySpawnPoints(const UPDStageDataAsset& StageAsset, int32 RoundIndex, TArray<FStageUnitSpawnPoint>& OutPoints, TArray<bool>& OutHasPoints);
	static void CollectAllySpawnPoints(const UPDStageDataAsset& StageAsset, int32 RoundIndex, TArray<FStageUnitSpawnPoint>& OutPoints, TArray<bool>& OutHasPoints);
};
